...
else if((ch_width_1>1460)&&(ch_width_4>1530))
{     
  digitalWrite(4,LOW); digitalWrite(5,HIGH);
 digitalWrite(6,LOW);digitalWrite(8,HIGH);
}

else if((ch_width_1<1460)&&(ch_width_4<1460))
{  digitalWrite(4,LOW); digitalWrite(5,HIGH);
 digitalWrite(6,HIGH);digitalWrite(8,LOW);
